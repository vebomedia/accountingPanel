 ...
 * 
 */
if (!function_exists('adminpanel_url'))
{
    function adminpanel_url($param = NULL, $locale = NULL)
    {
        if (empty($locale))
        {
        ...
        return site_url("adminpanel/$locale" . '/' . $param);
    }
...
if (!function_exists('adminpanel_assets'))
{
    function adminpanel_assets($param = NULL)
    {
        return site_url('assets/adminpanel/'. $param);
    }
}

//--------------------------------------------------------------------

if (!function_exists('adminpanel_view'))
{
    function adminpanel_view(string $name, array $data = [], array $options = []): string
    {
        $options['debug'] = false;

        return view('Adminpanel\\' . $name, $data, $options);
    }
