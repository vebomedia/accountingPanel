        ...
        <div class="form-row group_detail_bill_relation_perchase_invoice_items">
...
<?=form_input("c4_invoice_item[$key][c4_invoice_id]", $formData['c4_invoice_id'] ?? "", '', 'hidden');?> 
      ...
      data-required ="required" id="c4_invoice_item_' . $key .'_product_id4365" data-newinputname="c4_invoice_item[' . $key .'][new_product_id]""
      data-optionview="{name}" data-selectedview="{name}"  data-titleview="ID: {product_id}"    data-fillto="name as c4_invoice_item[' . $key .'][name],list_price as c4_invoice_item[' . $key .'][unit_price],vat_rate as c4_invoice_item[' . $key .'][vat_rate]"'); ?>
            ...
            <div class="form-group mt-1 col-sm-1"><button type="button" class="btn btn-sm btn-danger delete_detail_bill_relation_perchase_invoice_items"><i class="fa fa-times"></i></button></div>
