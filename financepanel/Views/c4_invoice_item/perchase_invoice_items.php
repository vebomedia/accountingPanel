<?php
$tableTitle = lang('c4_invoice_item._page_perchase_invoice_items');
?>
...
<div class="card border-light mb-0">
    <div  class="card-header bg-transparent">
        <div class="float-left text-center">
            <h5 class=""><i class="fas fa-sign-out-alt"></i> <?=$tableTitle; ?> &nbsp; <small><span class="date_title"></span></small></h5>
        </div>
        ...
        <ul class="nav nav-pills card-header-pills float-right">
            ...
            <?php
            $encoded   = '';
            $url       = financepanel_url('c4_invoice_item/showForm/perchase_invoice_items');           
            ...
            ?>
                            ...
                            <a class="nav-link  btn btn-sm btn-primary mr-1" 
                               ...
                               data-action="openformmodal">
                                <span>
                                    ...
                                    <span><?=lang('c4_invoice_item._form_perchase_invoice_items'); ?></span>
                                </span>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    <a class="nav-link btn btn-sm btn-primary mr-1 dropdown-toggle" data-toggle="collapse" href="#searchFormArea_perchase_invoice_items" aria-controls="searchFormArea_perchase_invoice_items" aria-expanded="false">
    ...
    <div class="card-body mb-0 pt-0">
        ...
        <!--begin: Search Form -->
        <div class="collapse p-1" id="searchFormArea_perchase_invoice_items">
            <div class="card card-body border-light p-0">

<?php echo form_open(financepanel_url('c4_invoice_item/readC4_invoice_item/perchase_invoice_items'), 'id="form_perchase_invoice_items"'); ?>
      ...
      data-relationformid="form_perchase_invoice_items" 
'); ?>
...
'); ?>
        ...
        <div class="collapse batchProcessing" id="batch_perchase_invoice_items">
            ...
            <?=lang('c4_invoice_item.currency'); ?> &nbsp; <span class="badge badge-light selectedCount">0</span>
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            ...
                                            <a class="dropdown-item" href="#"
                                               ...
                                               data-datatable="table_perchase_invoice_items" data-jsname="perchase_invoice_items"
        ...
        <!-- end: Batch Processing -->
            ...
            <div class="table-responsive">
                <table id="table_perchase_invoice_items" class="table table-hover" width="100%" cellspacing="0" data-url="<?=financepanel_url('c4_invoice_item/readC4_invoice_item/perchase_invoice_items');?>"></table>
            </div>
...
<script src="<?= financepanel_url('c4_invoice_item/langJS');?>"></script>
    ...
    <script src="<?= site_url('assets/financepanel/c4_invoice_item/perchase_invoice_items.js');?>"></script> 
