...
$url = financepanel_url('c4_shipment_document/save/outflow_shipment_document');
$hiddenArray = [];
...
$form_attr = 'id="outflow_shipment_document" autocomplete="off" role="presentation" data-pageslug="outflow_shipment_document" data-formslug="outflow_shipment_document"  data-jsname="outflow_shipment_document" data-modalsize="lg" data-packagelist="selectpicker,popover,datepicker,datetimepicker" data-closeonsave="true" class="bg-white crud4form"';

echo form_open($url, $form_attr, $hiddenArray); 
?>

<?=form_input("inflow", $formData['inflow'] ?? "0", '', 'hidden');?> 
<?=form_input("_formSlug", $formData['_formSlug'] ?? "outflow_shipment_document", '', 'hidden');?> 
<?=form_input("_pageSlug", $formData['_pageSlug'] ?? "outflow_shipment_document", '', 'hidden');?> 
<?=form_input("c4_shipment_document_id", $formData['c4_shipment_document_id'] ?? "", '', 'hidden');?> 
<?=form_input("inflow", '0', '', 'hidden');?>

<div class="modal-header">
    <h5 class="modal-title" id=""><i class="fas fa-ship"></i> <?=lang('c4_shipment_document._form_outflow_shipment_document'); ?> </h5>
