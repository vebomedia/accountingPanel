<?php
$tableTitle = lang('c4_stock_movement._page_inflow_stock_movement');
?>
...
<div class="card border-light mb-0">
    <div  class="card-header bg-transparent">
        <div class="float-left text-center">
            <h5 class=""><i class="fas fa-truck"></i> <?=$tableTitle; ?> &nbsp; <small><span class="date_title"></span></small></h5>
        </div>
        ...
        <ul class="nav nav-pills card-header-pills float-right">
            ...
            <?php
            $encoded   = '';
            $url       = financepanel_url('c4_stock_movement/showForm/stock_movement86369026');           
            ...
            ?>
                        ...
                        <li class="nav-item">
                            <a class="nav-link  btn btn-sm btn-primary mr-1" 
                               href="<?=$url;?>" 
                               data-modalsize="lg"
                               data-datatable="table_inflow_stock_movement"
                               data-modalurl="<?=$url;?>"
                               ...
                               data-action="openformmodal">
                                <span>
                                    ...
                                    <span><?=lang('c4_stock_movement._form_stock_movement86369026'); ?></span>
                                </span>
                            </a>
                        </li>
                ...
                <li class="nav-item">
                    <a class="nav-link btn btn-sm btn-primary mr-1 dropdown-toggle" data-toggle="collapse" href="#searchFormArea_inflow_stock_movement" aria-controls="searchFormArea_inflow_stock_movement" aria-expanded="false">
    ...
    <div class="card-body mb-0 pt-0">
        ...
        <!--begin: Search Form -->
        <div class="collapse p-1" id="searchFormArea_inflow_stock_movement">
            <div class="card card-body border-light p-0">

<?php echo form_open(financepanel_url('c4_stock_movement/readC4_stock_movement/inflow_stock_movement'), 'id="form_inflow_stock_movement"'); ?>
                
                        
<input type="hidden" name="inflow" value="1" style="display:none;" />
      ...
      data-relationformid="form_inflow_stock_movement" 
'); ?>
...
'); ?>
        ...
        <div class="collapse batchProcessing" id="batch_inflow_stock_movement">
            ...
            <div class="card border-light card-body mb-0">
                ...
                <div class="btn-group btn-group-sm" role="group" aria-label="Button group with nested dropdown">
                    ...
                    <div class="btn-group btn-group-sm ml-2 delete_link" role="group">
                        ...
                        data-datatable="table_inflow_stock_movement"  data-jsname="inflow_stock_movement"
        ...
        <!-- end: Batch Processing -->
            ...
            <div class="table-responsive">
                <table id="table_inflow_stock_movement" class="table table-hover" width="100%" cellspacing="0" data-url="<?=financepanel_url('c4_stock_movement/readC4_stock_movement/inflow_stock_movement');?>"></table>
            </div>
...
<script src="<?= financepanel_url('c4_stock_movement/langJS');?>"></script>
    ...
    <script src="<?= site_url('assets/financepanel/c4_stock_movement/inflow_stock_movement.js');?>"></script> 
