...
$url = financepanel_url('company/save/company');
$hiddenArray = [];
...
<div class="modal-header">
    <h5 class="modal-title" id=""><i class="fab fa-accessible-icon"></i> <?=lang('company._form_company'); ?> </h5>
...
<div class="input-group">
    ...
    <label class="label labelcropper" data-toggle="tooltip" title="" style="cursor: pointer;">
        ...
        <input type="file" name="file" accept="image/*" class="sr-only cropperjs" id="input_<?=$randomID;?>" 
            data-action="<?=financepanel_url("company/uploadFile/company/logo");?>" data-inputname="logo" data-idnumber="<?=$randomID;?>" 
