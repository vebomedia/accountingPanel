...
$url = financepanel_url('user/save/user');
$hiddenArray = [];
...
$form_attr = 'id="user" autocomplete="off" role="presentation" data-pageslug="user" data-formslug="user"  data-jsname="user" data-modalsize="lg" data-packagelist="selectpicker,popover,uisortable,cropperjs" data-closeonsave="true" class="bg-white crud4form"';
...
<div class="modal-header">
    <h5 class="modal-title" id=""><i class="fas fa-user"></i> <?=lang('user._form_user'); ?> </h5>
...
<div class="input-group">
    ...
    <label class="label labelcropper" data-toggle="tooltip" title="<?=lang("user.avatar_helpText")?>" style="cursor: pointer;">
        ...
        <input type="file" name="file" accept="image/*" class="sr-only cropperjs" id="input_<?=$randomID;?>" 
            data-action="<?=financepanel_url("user/uploadFile/user/avatar");?>" data-inputname="avatar" data-idnumber="<?=$randomID;?>" 
