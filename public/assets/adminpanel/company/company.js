    ...
    var init_datatable = function () {
        ...
        DT1 = $('#' + tableID).DataTable({
            ...
            {   
                ...
                title: companyLang('occupation_field'),
                data: function ( row, type, set, meta ) {
                    
                    if(typeof row.occupation_field !== 'string'){
                        return '';
                    }
                                        
                    var text = escapeHtml(row.occupation_field);
            ...
            {   
                sortable : true,
                name: 'logo',
                title: companyLang('logo'),
                data: function ( row, type, set, meta ) {
                
                    if(!isEmpty(row.logo_c4_url_thumb))
                    {
                        
                        $x =  '<img src="' + (row.logo_c4_url_thumb) + '" onerror="this.src=\'https://resources.crud4.com/v1/images/notfound.png\'" class="img-thumbnail" width="60" height="60"></img>';
                        return $x; 
            ...
            {   
                ...
                name: 'legal_name',
                title: companyLang('legal_name'),
                data: function ( row, type, set, meta ) {
                    
                    if(typeof row.legal_name !== 'string'){
                        return '';
                    }
                                        
                    var text = escapeHtml(row.legal_name);
            ...
            {   
                ...
                name: 'tax_number',
                title: companyLang('tax_number'),
                data: function ( row, type, set, meta ) {
                    
                    if(typeof row.tax_number !== 'string'){
                        return '';
                    }
                                        
                    var text = escapeHtml(row.tax_number);
            ...
            {   
                ...
                name: 'tax_office',
                title: companyLang('tax_office'),
                data: function ( row, type, set, meta ) {
                    
                    if(typeof row.tax_office !== 'string'){
                        return '';
                    }
                                        
                    var text = escapeHtml(row.tax_office);
            ...
            {   
                ...
                name: 'country_id',
                title: companyLang('country_id'),
                data: function ( row, type, set, meta ) {
                    
                    if(typeof row.country_id !== 'string'){
                        return '';
                    }
                                        
                    var text = escapeHtml(row.country_id);
            ...
            {   
                ...
                name: 'zone_id',
                title: companyLang('zone_id'),
                data: function ( row, type, set, meta ) {
                    
                    if(typeof row.zone_id !== 'string'){
                        return '';
                    }
                                        
                    var text = escapeHtml(row.zone_id);
